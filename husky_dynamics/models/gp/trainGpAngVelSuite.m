...
trainStructCommon.fnameTrain = '../../data/dataset_gp_ang_vel_1_train_subsampled';
trainStructCommon.infMethod = @infExact;
trainStructCommon.likFunc = @likGauss;
trainStructCommon.maxIterations = 50;
trainStructCommon.gpWrapperName = 'gpAngVel';

testStructCommon.gpWrapperName = 'gpAngVel';
testStructCommon.datasetFname = '../../data/dataset_gp_ang_vel_1_hold.mat';
...
for i = 1:nParams
    ...
    trainStruct.gpWrapperFname = sprintf('gp_ang_vel_suite_%s_%d',myDateStamp(2:3),i);
