...
quiverScale = 1e-3;
plot(u,v,'b-+'); 
quiver(statesInit(:,1),statesInit(:,2),...
    quiverScale*cos(statesInit(:,3)),quiverScale*sin(statesInit(:,3)),...
    'color',[0 0 1],'showarrowhead','off','autoscale','off');
quiver(statesFinal(:,1),statesFinal(:,2),...
    quiverScale*cos(statesFinal(:,3)),quiverScale*sin(statesFinal(:,3)),...
    'color',[0 0 1],'showarrowhead','off','autoscale','off');
plot(p,q,'r--+');
quiver(statesFinalPred(:,1),statesFinalPred(:,2),...
